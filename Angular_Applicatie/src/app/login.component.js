...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.login = function (username, password) {
        ...
        return this.http.post(this.loginUrl, body, options).subscribe(function (data) { return _this.loginResponse(data); }, function (err) { return _this.handleError(err); }, function () { return console.log('login completed'); });
    };
